...
import electrum_fec.trampoline
from electrum_fec import bitcoin
from electrum_fec import util
from electrum_fec import constants
from electrum_fec.network import Network
from electrum_fec.ecc import ECPrivkey
from electrum_fec import simple_config, lnutil
from electrum_fec.lnaddr import lnencode, LnAddr, lndecode
from electrum_fec.bitcoin import COIN, sha256
from electrum_fec.util import bh2u, NetworkRetryManager, bfh, OldTaskGroup, EventListener
from electrum_fec.lnpeer import Peer
from electrum_fec.lnutil import LNPeerAddr, Keypair, privkey_to_pubkey
from electrum_fec.lnutil import PaymentFailure, LnFeatures, HTLCOwner
from electrum_fec.lnchannel import ChannelState, PeerState, Channel
from electrum_fec.lnrouter import LNPathFinder, PathEdge, LNPathInconsistent
from electrum_fec.channel_db import ChannelDB
from electrum_fec.lnworker import LNWallet, NoPathFound
from electrum_fec.lnmsg import encode_msg, decode_msg
from electrum_fec import lnmsg
from electrum_fec.logging import console_stderr_handler, Logger
from electrum_fec.lnworker import PaymentInfo, RECEIVED
from electrum_fec.lnonion import OnionFailureCode
from electrum_fec.lnutil import derive_payment_secret_from_payment_preimage, UpdateAddHtlc
from electrum_fec.lnutil import LOCAL, REMOTE
from electrum_fec.invoices import PR_PAID, PR_UNPAID
from electrum_fec.interface import GracefulDisconnect
    ...
    def test_reestablish_replay_messages_rev_then_sig(self):
        ...
        async def f():
            ...
            async with OldTaskGroup() as group:
                await group.spawn(p1._message_loop())
                await group.spawn(p2._message_loop())
                with self.assertLogs('electrum_fec', level='INFO') as logs:
