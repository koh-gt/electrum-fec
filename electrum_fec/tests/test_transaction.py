...
from electrum_fec import transaction, bitcoin
from electrum_fec.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
...
from electrum_fec.bitcoin import (deserialize_privkey, opcodes,
...
class TestTransaction(ElectrumTestCase):
    ...
    def test_estimated_output_size(self):
        ...
        self.assertEqual(estimated_output_size('fec1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e'), 31)
        self.assertEqual(estimated_output_size('fec1qnvks7gfdu72de8qv6q6rhkkzu70fqz4wpjzuxjf6aydsx7wxfwcqsmgvk5'), 43)
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual('fec1qw508d6qejxtdg4y5r3zarvary0c5xw7kgmn4n9', addr_from_script('0014751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('fec1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k6hvnsv', addr_from_script('5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('fec1sw50qh55pvk', addr_from_script('6002751e'))
        self.assertEqual('fec1zw508d6qejxtdg4y5r3zarvaryvc7v05v', addr_from_script('5210751e76e8199196d454941c45d1b3a323'))
        self.assertEqual('fec1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqpj6zg2', addr_from_script('512079be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798'))
...
class TestTransactionTestnet(TestCaseForTestnet):
    ...
    def test_spending_op_cltv_p2sh(self):
        ...
        txout = PartialTxOutput.from_address_and_value(
            'tfec1qv9hg20f0g08d460l67ph6p4ukwt7m0tte2sqtl', sats_less_fees)
    ...
    def test_spending_op_cltv_p2wsh(self):
        ...
        self.assertEqual("tfec1q9dn6qke9924xe3zmptmhrdge0s043pjxpjndypgnu2t9fvsd4crs4rwaxu", from_addr)
        ...
        # Build the Transaction Output
        txout = PartialTxOutput.from_address_and_value(
            'tfec1qtgsfkgptcxdn6dz6wh8c4dguk3cezwned6kx9h', sats_less_fees)
