...
from electrum_fec.wallet_db import FINAL_SEED_VERSION
from electrum_fec.wallet import (Abstract_Wallet, Standard_Wallet, create_new_wallet,
                                 restore_wallet_from_text, Imported_Wallet, Wallet)
from electrum_fec.exchange_rate import ExchangeBase, FxThread
from electrum_fec.util import TxMinedInfo, InvalidPassword
...
class TestCreateRestoreWallet(WalletTestCase):
    ...
    def test_restore_wallet_from_text_mnemonic(self):
        ...
        self.assertEqual(encrypt_file, wallet.storage.is_encrypted())
        self.assertEqual('fec1q2ccr34wzep58d4239tl3x3734ttle92arvely7', wallet.get_receiving_addresses()[0])
    ...
    def test_restore_wallet_from_text_no_storage(self):
        ...
        self.assertEqual('fec1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e', wallet.get_receiving_addresses()[0])
    ...
    def test_restore_wallet_from_text_addresses(self):
        text = 'fec1q2ccr34wzep58d4239tl3x3734ttle92arvely7 fec1qnp78h78vp92pwdwq5xvh8eprlga5q8gu7xl7hg'
        ...
        wallet.delete_address('fec1qnp78h78vp92pwdwq5xvh8eprlga5q8gu7xl7hg')
    ...
    def test_restore_wallet_from_text_privkeys(self):
        ...
        self.assertEqual('fec1q2ccr34wzep58d4239tl3x3734ttle92arvely7', addr0)
