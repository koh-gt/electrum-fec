...
from electrum_fec.util import (format_satoshis, format_fee_satoshis, parse_URI,
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_address(self):
        self._do_test_parse_URI('ferrite:LectrumELqJWMECz7W2iarBpT4VvAPqwAv',
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('ferrite:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?label=electrum%20test',
                                {'address': 'LectrumELqJWMECz7W2iarBpT4VvAPqwAv', 'label': 'electrum test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('ferrite:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?message=electrum%20test',
                                {'address': 'LectrumELqJWMECz7W2iarBpT4VvAPqwAv', 'message': 'electrum test', 'memo': 'electrum test'})

    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('ferrite:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?amount=0.0003',
                                {'address': 'LectrumELqJWMECz7W2iarBpT4VvAPqwAv', 'amount': 30000})

    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI('ferrite:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'address': 'LectrumELqJWMECz7W2iarBpT4VvAPqwAv', 'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_ignore_args(self):
        self._do_test_parse_URI('ferrite:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?test=test',
                                {'address': 'LectrumELqJWMECz7W2iarBpT4VvAPqwAv', 'test': 'test'})

    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('ferrite:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
    ...
    def test_parse_URI_no_address_request_url(self):
        self._do_test_parse_URI('ferrite:?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_invalid_address(self):
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'ferrite:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'notferrite:LPzGaoLUtXFkmNo3u1chDxGxDnSaBQTTxm')

    def test_parse_URI_parameter_pollution(self):
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'ferrite:LPzGaoLUtXFkmNo3u1chDxGxDnSaBQTTxm?amount=0.0003&label=test&amount=30.0')
    ...
    def test_parse_URI_lightning_consistency(self):
        ...
        self._do_test_parse_URI('ferrite:?lightning=',
                                {'lightning': ''})
        # bip21 uri that *only* includes a "lightning" key. LN part has fallback address
        self._do_test_parse_URI('ferrite:?lightning=',
                                {'lightning': ''})
        # bip21 uri that includes "lightning" key. LN part does not have fallback address
        self._do_test_parse_URI('ferrite:tfec1qu5ua3szskclyd48wlfdwfd32j65phxy9apu6mk?amount=0.0007&message=test266&lightning=',
                                {'address': 'tfec1qu5ua3szskclyd48wlfdwfd32j65phxy9apu6mk',
                                 'amount': 70000,
                                 'lightning': '',
                                 'memo': 'test266',
                                 'message': 'test266'})
        # bip21 uri that includes "lightning" key. LN part has fallback address
        self._do_test_parse_URI('ferrite:tfec1qu5ua3szskclyd48wlfdwfd32j65phxy9apu6mk?amount=0.0007&message=test266&lightning=',
                                {'address': 'tfec1qu5ua3szskclyd48wlfdwfd32j65phxy9apu6mk',
                                 'amount': 70000,
                                 'lightning': '',
                                 'memo': 'test266',
        ...
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'ferrite:tfec1qvu0c9xme0ul3gzx4nzqdgxsu25acuk9w4cs5zr?amount=0.0007&message=test266&lightning=')
        # bip21 uri that includes "lightning" key. top-level amount mismatches LN amount
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'ferrite:tfec1qu5ua3szskclyd48wlfdwfd32j65phxy9apu6mk?amount=0.0008&message=test266&lightning=')
        # bip21 uri that includes "lightning" key with garbage unparseable value
        self.assertRaises(InvalidBitcoinURI, parse_URI, 'ferrite:tfec1qu5ua3szskclyd48wlfdwfd32j65phxy9apu6mk?amount=0.0008&message=test266&lightning=lntb700u1p3kqy26pp5l7rj7w0u5sdsj24umzdlhdasdasdasdasd')
