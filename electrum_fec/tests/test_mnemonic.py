...
from electrum_fec import slip39
from electrum_fec import old_mnemonic
from electrum_fec.util import bh2u, bfh
from electrum_fec.mnemonic import is_new_seed, is_old_seed, seed_type
from electrum_fec.version import SEED_PREFIX_SW, SEED_PREFIX
