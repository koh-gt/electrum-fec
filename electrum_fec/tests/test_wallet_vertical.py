...
from electrum_fec import storage, bitcoin, keystore, bip32, slip39, wallet
from electrum_fec import Transaction
from electrum_fec import SimpleConfig
from electrum_fec import util
from electrum_fec.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_fec.wallet import (sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet,
                                 restore_wallet_from_text, Abstract_Wallet, BumpFeeStrategy)
from electrum_fec.util import (
    bfh, bh2u, NotEnoughFunds, UnrelatedTransactionException,
    UserFacingException)
from electrum_fec.transaction import (TxOutput, Transaction, PartialTransaction, PartialTxOutput,
                                      PartialTxInput, tx_from_any, TxOutpoint)
from electrum_fec.mnemonic import seed_type
from electrum_fec.network import Network
...
class TestWalletKeystoreAddressIntegrityForMainnet(ElectrumTestCase):
    ...
    def test_electrum_seed_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'fec1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e')
        self.assertEqual(w.get_change_addresses()[0], 'fec1qdy94n2q5qcp0kg7v9yzwe6wvfkhnvyzjazfzj3')
    ...
    def test_electrum_seed_segwit_passphrase(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'fec1qx94dutas7ysn2my645cyttujrms5d9p564qe9t')
        self.assertEqual(w.get_change_addresses()[0], 'fec1qcywwsy87sdp8vz5rfjh3sxdv6rt95kujfu64lc')
    ...
    def test_bip39_seed_bip84_native_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'fec1qcr8te4kr609gcawutmrza0j4xv80jy8z4nqduv')
        self.assertEqual(w.get_change_addresses()[0], 'fec1q8c6fshw2dlwun7ekn9qwf37cu2rn755u9ym7p0')
    ...
    def test_electrum_multisig_seed_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'fec1qvzezdcv6vs5h45ugkavp896e0nde5c5lg5h0fwe2xyfhnpkxq6gqa9a79a')
        self.assertEqual(w.get_change_addresses()[0], 'fec1qxqf840dqswcmu7a8v82fj6ej0msx08flvuy6kngr7axstjcaq6usxndfdg')
    ...
    def test_bip32_extended_version_bytes(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'fec1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsncccvf')
        self.assertEqual(w.get_change_addresses()[0], 'fec1qjy5zunxh6hjysele86qqywfa437z4xwmm96rkx')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'fec1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qaxz66u')
        self.assertEqual(w.get_change_addresses()[0], 'fec1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tsqjxpj4')
    ...
    def test_slip39_groups_128bit_bip84_native_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'fec1qaggygkqgqjjpt58zrmhvjz5m9dj8mjsh2n99sv')
        self.assertEqual(w.get_change_addresses()[0], 'fec1q8l6hcvlczu4mtjcnlwhczw7vdxnvwccpkrtukj')
...
class TestWalletKeystoreAddressIntegrityForTestnet(TestCaseForTestnet):
    ...
    def test_bip32_extended_version_bytes(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tfec1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsy2m3lr')
        self.assertEqual(w.get_change_addresses()[0], 'tfec1qjy5zunxh6hjysele86qqywfa437z4xwmvhe29v')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tfec1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qkfxy9f')
        self.assertEqual(w.get_change_addresses()[0], 'tfec1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tstazldq')
...
class TestWalletSending(TestCaseForTestnet):
    ...
    def _bump_fee_p2wpkh_when_there_is_only_a_single_output_and_that_is_a_change_address(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value('tfec1q7rl9cxr85962ztnsze089zs8ycv52hk4gpn946', '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325499
    ...
    def _rbf_batching(self, *, simulate_moving_txs, config):
        ...
        outputs = [PartialTxOutput.from_address_and_value('tfec1qy6xmdj96v5dzt3j08hgc05yk3kltqsnmhapynd', 2_500_000)]
        coins = wallet.get_spendable_coins(domain=None)
    ...
    def test_sweep_p2pk(self):
        ...
        network = NetworkMock()
        dest_addr = 'tfec1q3ws2p0qjk5vrravv065xqlnkckvzcpcl0k88vr'
    ...
    def test_coinjoin_between_two_p2wpkh_electrum_seeds(self, mock_save_db):
        ...
        outputs = [PartialTxOutput.from_address_and_value("tfec1qhye4wfp26kn0l7ynpn5a4hvt539xc3zfkmuymc", 10_000_000)]
        ...
        outputs = [PartialTxOutput.from_address_and_value("tfec1qufnj5k2rrsnpjq7fg6d2pq3q9um6skdya34syj", 10_000_000)]
    ...
    def test_standard_wallet_cannot_sign_multisig_input_even_if_cosigner(self, mock_save_db):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value('tfec1qfrlx5pza9vmez6vpx7swt8yp0nmgz3qa86sgvq', 100_000)]
        ...
        self.assertEqual('tfec1qxq5crk6yadw66rdt8xr3xj5ctvmq4c3z0fl85yx0ar8l6ga6ehysfvlnuf', tx.inputs()[0].address)
        self.assertEqual('tfec1qfrlx5pza9vmez6vpx7swt8yp0nmgz3qa86sgvq',                     tx.outputs()[0].address)
        self.assertEqual('tfec1qadpg5z77egkpkde34mdcrsz3s3tgwk5ew4w3wlfqf4j3dk8kkvrswgd6vs', tx.outputs()[1].address)
    ...
    def test_wallet_history_chain_of_unsigned_transactions(self, mock_save_db):
        ...
        # create tx1
        outputs = [PartialTxOutput.from_address_and_value('tfec1qsfcddwf7yytl62e3catwv8hpl2hs9e363z67kk', 100000)]
        coins = wallet.get_spendable_coins(domain=None)
        ...
        outputs = [PartialTxOutput.from_address_and_value('tfec1qq0lm9esmq6pfjc3jls7v6twy93lnqcs8dxa48c', '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1938863
    ...
    def test_wallet_does_not_create_zero_input_tx(self, mock_save_db):
        ...
        with self.subTest(msg="no coins to use as inputs, max output value, zero fee"):
            outputs = [PartialTxOutput.from_address_and_value('tfec1qsfcddwf7yytl62e3catwv8hpl2hs9e363z67kk', '!')]
            coins = wallet.get_spendable_coins(domain=None)
        ...
        with self.subTest(msg="funded wallet, zero output value, zero fee"):
            outputs = [PartialTxOutput.from_address_and_value('tfec1qsfcddwf7yytl62e3catwv8hpl2hs9e363z67kk', 0)]
            coins = wallet.get_spendable_coins(domain=None)
            tx = wallet.make_unsigned_transaction(coins=coins, outputs=outputs, fee=0)
            self.assertEqual(1, len(tx.inputs()))
    ...
    def test_imported_wallet_usechange_off(self, mock_save_db):
        ...
        outputs = [PartialTxOutput.from_address_and_value('tfec1qq4pypzwxf5uanfyckmsu3ejxxf6rrvjqplqrp9', 49646)]
        coins = wallet.get_spendable_coins(domain=None)
        ...
        self.assertEqual(2, len(tx.outputs()))
        self.assertTrue(tx.output_value_for_address("tfec1q0fj7pxa3m2q2hlr964zn3z3wvx4t03epdp2d8d") > 0)
        self.assertEqual(49646, tx.output_value_for_address("tfec1qq4pypzwxf5uanfyckmsu3ejxxf6rrvjqplqrp9"))
    ...
    def test_imported_wallet_usechange_on(self, mock_save_db):
        ...
        self.assertEqual(2, len(tx.outputs()))
        self.assertTrue(tx.output_value_for_address("tfec1qetcgdwuzlpdnt5fmzxxdpczjhadz06cy2ff439") > 0)
        self.assertEqual(49646, tx.output_value_for_address("tfec1qq4pypzwxf5uanfyckmsu3ejxxf6rrvjqplqrp9"))
    ...
    def test_get_spendable_coins(self, mock_save_db):
        ...
        self.assertEqual(
            {'52e669a20a26c8b3df5b41e5e6309b18bcde8e1ad7ea17a18f63b6dc6c8becc0:1'},
            {txi.prevout.to_str() for txi in wallet.get_spendable_coins(["tfec1q6n99dl96mx8mfh90m3tn5awk5mllkzdhnu0swt"])})
        # test freezing an address
        wallet.set_frozen_state_of_addresses(["tfec1q6n99dl96mx8mfh90m3tn5awk5mllkzdhnu0swt"], freeze=True)
        self.assertEqual(
            {'c36a6e1cd54df108e69574f70bc9b88dc13beddc70cfad9feb7f8f6593255d4a:1'},
            {txi.prevout.to_str() for txi in wallet.get_spendable_coins()})
        wallet.set_frozen_state_of_addresses(["tfec1q6n99dl96mx8mfh90m3tn5awk5mllkzdhnu0swt"], freeze=False)
        self.assertEqual(
            {'c36a6e1cd54df108e69574f70bc9b88dc13beddc70cfad9feb7f8f6593255d4a:1',
             '52e669a20a26c8b3df5b41e5e6309b18bcde8e1ad7ea17a18f63b6dc6c8becc0:1'},
            {txi.prevout.to_str() for txi in wallet.get_spendable_coins()})
    ...
    def test_export_psbt_with_xpubs__multisig(self, mock_save_db):
        ...
        outputs = [PartialTxOutput.from_address_and_value("tfec1q0ezagv55krljkz9973fryeyczhj3dnls3td5ch", 123456)]
        coins = wallet.get_spendable_coins(domain=None)
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_old_electrum_seed_online_mpk(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value('tfec1qyw3c0rvn6kk2c688y3dygvckn57525y8emy4p5', 2500000)]
    ...
    def test_sending_offline_xprv_online_xpub_p2pkh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value('tfec1qp0mv2sxsyxxfj5gl0332f9uyez93su9cszcqyh', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
        tx.version = 1
    ...
    def test_sending_offline_wif_online_addr_p2pkh(self, mock_save_db):  # compressed pubkey
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value('tfec1quk7ahlhr3qmjndy0uvu9y9hxfesrtahtj48k8j', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
        tx.version = 1
    ...
    def test_sending_offline_wif_online_addr_p2wpkh(self, mock_save_db):
        ...
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
        wallet_online.import_address('tfec1qm2eh4787lwanrzr6pf0ekf5c7jnmghm2ad526v')
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh(self, mock_save_db):
        ...
        # ^ third seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
        wallet_online.import_address('tfec1q83p6eqxkuvq4eumcha46crpzg4nj84s9p0hnynkxg8nhvfzqcc7q26lnr9')
...
class TestWalletHistory_EvilGapLimit(TestCaseForTestnet):
    ...
    def test_restoring_wallet_txorder1(self, mock_save_db):
        ...
        w.adb.receive_history_callback('tfec1qgh5c088he4d559wl0hw27hrdeg8p2z96c3td9f',  # HD index 1
                                   [('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)],
                                   {})
        w.synchronize()
        w.adb.receive_history_callback('tfec1qm0ejr6g964zt2jux5te7m9ds43n28hds528z0k',  # HD index 3
                                   [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)],
                                   {})
        w.synchronize()
        w.adb.receive_history_callback('tfec1qj4pnq958k89zcem3342lhcgyz0rnmhkzxjy3gk',  # HD index 4
                                   [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917)],
                                   {})
        w.synchronize()
        w.adb.receive_history_callback('tfec1q3pyjwpm8wxgvquak240mprfhaydmkawcfhg2zs',  # HD index 15
                                   [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)],
                                   {})
        w.synchronize()
        w.adb.receive_history_callback('tfec1qr0qjp99ygawul0eylxfqmt7alygye22mtenjfm',  # HD index 25
                                   [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917),
                                    ('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)],
                                   {})
        w.synchronize()
...
class TestImportedWallet(TestCaseForTestnet):
    ...
    def test_importing_and_deleting_addresses(self, mock_save_db):
        w = restore_wallet_from_text("tfec1q7648a2pm2se425lvun0g3vlf4ahmflctw32u2c",
                                     path='if_this_exists_mocking_failed_648151893',
                                     config=self.config)['wallet']  # type: Abstract_Wallet
        ...
        w.import_address("tfec1qsyzgpwa0vg2940u5t6l97etuvedr5dejcp84ad")
        ...
        w.delete_address("tfec1q7648a2pm2se425lvun0g3vlf4ahmflctw32u2c")
        self.assertEqual(2, len(w.db.transactions))
        self.assertEqual(
        ...
        with self.assertRaises(UserFacingException) as ctx:
            w.delete_address("tfec1qsyzgpwa0vg2940u5t6l97etuvedr5dejcp84ad")
