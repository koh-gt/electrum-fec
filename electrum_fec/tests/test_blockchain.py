...
from electrum_fec import constants, blockchain
from electrum_fec.simple_config import SimpleConfig
from electrum_fec.blockchain import Blockchain, deserialize_header, hash_header
from electrum_fec.util import bh2u, bfh, make_dir
...
class TestVerifyHeader(ElectrumTestCase):
    ...
    # Data for Ferrite block header #100.
