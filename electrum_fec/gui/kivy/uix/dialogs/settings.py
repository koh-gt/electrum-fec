...
from electrum_fec.util import base_units_list
from electrum_fec.i18n import languages
from electrum_fec.gui.kivy.i18n import _
from electrum_fec.plugin import run_hook
from electrum_fec import coinchooser
...
#:import messages electrum_fec.gui.messages
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Ferrite amounts.")
