...
from electrum_fec.util import is_valid_email
...
#:import _ electrum_fec.gui.kivy.i18n._
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_fec.mnemonic import Mnemonic
        from electrum_fec.old_mnemonic import wordlist as old_wordlist
    ...
    def update_next_button(self):
        from electrum_fec.keystore import bip39_is_checksum_valid
        text = self.get_text()
        if self.is_bip39:
