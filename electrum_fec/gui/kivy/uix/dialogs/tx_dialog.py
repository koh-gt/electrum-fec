...
from electrum_fec.util import InvalidPassword
from electrum_fec.address_synchronizer import TX_HEIGHT_LOCAL
from electrum_fec.wallet import CannotBumpFee, CannotCPFP, CannotDoubleSpendTx
from electrum_fec.transaction import Transaction, PartialTransaction
from electrum_fec.network import NetworkException

from electrum_fec.gui.kivy.i18n import _
from electrum_fec.gui.kivy.util import address_colors
...
Builder.load_string('''
#:import KIVY_GUI_PATH electrum_fec.gui.kivy.KIVY_GUI_PATH
