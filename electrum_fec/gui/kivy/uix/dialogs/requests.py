...
<RequestItem@CardItem>
    ...
    status: ''
    date: ''
    icon: 'atlas://electrum_fec/gui/kivy/theming/light/important'
    Image:
        id: icon
        source: root.icon
        size_hint: None, 1
...
from electrum_fec.util import format_time
from electrum_fec.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrum_fec.gui.kivy.uix.context_menu import ContextMenu

pr_icon = {
    PR_UNPAID: 'atlas://electrum_fec/gui/kivy/theming/light/important',
    PR_UNKNOWN: 'atlas://electrum_fec/gui/kivy/theming/light/important',
    PR_PAID: 'atlas://electrum_fec/gui/kivy/theming/light/confirmed',
    PR_EXPIRED: 'atlas://electrum_fec/gui/kivy/theming/light/close'
}
request_text = {
    PR_UNPAID: _('Pending'),
