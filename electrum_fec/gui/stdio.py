...
from electrum_fec import WalletStorage, Wallet
from electrum_fec.wallet import Abstract_Wallet
from electrum_fec.wallet_db import WalletDB
from electrum_fec.util import format_satoshis, EventListener, event_listener
from electrum_fec.bitcoin import is_address, COIN
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Ferrite address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-fec setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-fec setconfig' to change your settings")
        return True
