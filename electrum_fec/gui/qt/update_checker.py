...
from electrum_fec.util import make_aiohttp_session
from electrum_fec.logging import Logger
from electrum_fec.network import Network
from electrum_fec._vendor.distutils.version import LooseVersion


class UpdateCheck(QDialog, Logger):
    url = "https://electrum-fec.org/version"
    download_url = "https://electrum-fec.org/#download"
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Electrum-FEC - ' + _('Update Check'))
