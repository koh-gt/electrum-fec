...
from electrum_fec import util, paymentrequest
from electrum_fec import lnutil
from electrum_fec.plugin import run_hook
from electrum_fec.i18n import _
from electrum_fec.util import (get_asyncio_loop, bh2u, FailedToParsePaymentIdentifier,
...
from electrum_fec.transaction import Transaction, PartialTxInput, PartialTransaction, PartialTxOutput
from electrum_fec.network import TxBroadcastError, BestEffortRequestFailed
...
class SendTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        msg = (_("Recipient of the funds.") + "\n\n"
               + _("You may enter a Ferrite address, a label from your list of contacts "
                   "(a list of completions will be proposed), "
                   "or an alias (email-like address that forwards to a Ferrite address)") + ". "
    ...
    def check_send_tab_onchain_outputs_and_show_errors(self, outputs: List[PartialTxOutput]) -> bool:
        ...
        for o in outputs:
            if o.scriptpubkey is None:
                self.show_error(_('Ferrite Address is None'))
                return True
            if o.value is None:
