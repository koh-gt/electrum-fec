...
from electrum_fec.bitcoin import is_address
from electrum_fec.i18n import _
from electrum_fec.util import InvoiceError
from electrum_fec.invoices import PR_DEFAULT_EXPIRATION_WHEN_CREATING
from electrum_fec.invoices import PR_EXPIRED, pr_expiration_values
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        msg = ''.join([
            ...
            _('The ferrite address never expires and will always be part of this electrum wallet.'), ' ',
            _('You can reuse a ferrite address any number of times but it is not good for your privacy.'),
            '\n\n',
