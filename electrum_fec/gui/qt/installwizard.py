...
from electrum_fec.util import UserCancelled, InvalidPassword, WalletFileException, get_new_wallet_name
from electrum_fec.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack, ReRunDialog
...
from electrum_fec.plugin import run_hook, Plugins
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins', *, gui_object: 'ElectrumGui'):
        ...
        self.setWindowTitle('Electrum-FEC  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon('electrum-fec.png')
        self.show()
        self.raise_()
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Electrum-FEC wallet'))
