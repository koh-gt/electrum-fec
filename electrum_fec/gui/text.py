...
from electrum_fec.util import format_satoshis, format_time
from electrum_fec.util import EventListener, event_listener
from electrum_fec.bitcoin import is_address, address_to_script, COIN
from electrum_fec.transaction import PartialTxOutput
from electrum_fec.wallet import Wallet, Abstract_Wallet
from electrum_fec.wallet_db import WalletDB
from electrum_fec.storage import WalletStorage
from electrum_fec.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_fec.interface import ServerAddr
from electrum_fec.invoices import Invoice
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def __init__(self, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'electrum-fec create'")
            exit()
