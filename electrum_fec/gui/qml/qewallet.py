...
from electrum_fec.invoices import InvoiceError, PR_DEFAULT_EXPIRATION_WHEN_CREATING, PR_PAID
...
from electrum_fec.util import (parse_max_spend, InvalidPassword, event_listener)
...
class QEWallet(AuthMixin, QObject, QtEventListener):
    ...
    def send_onchain(self, address, amount, fee=None, rbf=False):
        ...
        if not bitcoin.is_address(address):
            self._logger.warning('Invalid Ferrite Address: ' + address)
            return False
