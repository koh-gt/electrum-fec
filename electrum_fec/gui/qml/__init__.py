...
from electrum_fec.i18n import set_language, languages
from electrum_fec.plugin import run_hook
from electrum_fec.util import (profiler)
...
class ElectrumGui(Logger):
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        self.app.engine.load('electrum_fec/gui/qml/components/main.qml')
