...
WizardComponent {
    ...
    ColumnLayout {
        ...
        Label { text: qsTr('Import Ferrite Addresses') }

        InfoTextArea {
            Layout.preferredWidth: parent.width
            text: qsTr('Enter a list of Ferrite addresses (this will create a watching-only wallet), or a list of private keys.')
        }
