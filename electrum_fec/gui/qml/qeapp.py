...
from electrum_fec import version
from electrum_fec.logging import Logger, get_logger
from electrum_fec.util import BITCOIN_BIP21_URI_SCHEME, LIGHTNING_URI_SCHEME
...
class ElectrumQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, config, daemon, plugins):
        ...
        qmlRegisterType(QEWallet, 'org.electrum_fec', 1, 0, 'Wallet')
        qmlRegisterType(QEWalletDB, 'org.electrum_fec', 1, 0, 'WalletDB')
        qmlRegisterType(QEBitcoin, 'org.electrum_fec', 1, 0, 'Bitcoin')
        qmlRegisterType(QEQRParser, 'org.electrum_fec', 1, 0, 'QRParser')
        qmlRegisterType(QEFX, 'org.electrum_fec', 1, 0, 'FX')
        qmlRegisterType(QETxFinalizer, 'org.electrum_fec', 1, 0, 'TxFinalizer')
        qmlRegisterType(QEInvoice, 'org.electrum_fec', 1, 0, 'Invoice')
        qmlRegisterType(QEInvoiceParser, 'org.electrum_fec', 1, 0, 'InvoiceParser')
        qmlRegisterType(QEUserEnteredPayment, 'org.electrum_fec', 1, 0, 'UserEnteredPayment')
        qmlRegisterType(QEAddressDetails, 'org.electrum_fec', 1, 0, 'AddressDetails')
        qmlRegisterType(QETxDetails, 'org.electrum_fec', 1, 0, 'TxDetails')
        qmlRegisterType(QEChannelOpener, 'org.electrum_fec', 1, 0, 'ChannelOpener')
        qmlRegisterType(QELnPaymentDetails, 'org.electrum_fec', 1, 0, 'LnPaymentDetails')
        qmlRegisterType(QEChannelDetails, 'org.electrum_fec', 1, 0, 'ChannelDetails')
        qmlRegisterType(QESwapHelper, 'org.electrum_fec', 1, 0, 'SwapHelper')
        qmlRegisterType(QERequestDetails, 'org.electrum_fec', 1, 0, 'RequestDetails')
        qmlRegisterType(QETxFeeBumper, 'org.electrum_fec', 1, 0, 'TxFeeBumper')

        qmlRegisterUncreatableType(QEAmount, 'org.electrum_fec', 1, 0, 'Amount', 'Amount can only be used as property')
        qmlRegisterUncreatableType(QENewWalletWizard, 'org.electrum_fec', 1, 0, 'NewWalletWizard', 'NewWalletWizard can only be used as property')
        qmlRegisterUncreatableType(QEServerConnectWizard, 'org.electrum_fec', 1, 0, 'ServerConnectWizard', 'ServerConnectWizard can only be used as property')
        ...
        not_loaded = QFontDatabase.addApplicationFont('electrum_fec/gui/qml/fonts/PTMono-Regular.ttf') < 0
        not_loaded = QFontDatabase.addApplicationFont('electrum_fec/gui/qml/fonts/PTMono-Bold.ttf') < 0 and not_loaded
        if not_loaded:
