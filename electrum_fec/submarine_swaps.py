...
API_URL_MAINNET = 'https://swaps.electrum-fec.org/api'
API_URL_TESTNET = 'https://swaps.electrum-fec.org/testnet'
...
class SwapManager(Logger):
    ...
    async def normal_swap(
        ...
        """send on-chain FEC, receive on Lightning
    ...
    async def get_pairs(self) -> None:
        ...
        limits = pairs['pairs']['FEC/FEC']['limits']
