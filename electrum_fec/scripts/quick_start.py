...
from electrum_fec.wallet import Wallet, create_new_wallet
from electrum_fec.wallet_db import WalletDB
from electrum_fec.commands import Commands
from electrum_fec.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-fec/testnet as datadir
