...
from electrum_fec.util import print_msg, create_and_start_event_loop
from electrum_fec.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <ferrite_address>")
    sys.exit(1)
