...
from electrum_fec.util import bfh, bh2u, versiontuple, UserCancelled, UserFacingException
from electrum_fec.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32 as parse_path
from electrum_fec import constants
from electrum_fec.i18n import _
from electrum_fec.plugin import Device, runs_in_hwd_thread
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Testnet" if constants.net.TESTNET else "Ferrite"
