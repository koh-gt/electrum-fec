...
from electrum_fec.util import UserCancelled, UserFacingException
from electrum_fec.keystore import bip39_normalize_passphrase
...
from electrum_fec.plugin import runs_in_hwd_thread
from electrum_fec.plugins.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def get_passphrase(self, available_on_device):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the ferrites in the wallet.").format(self.device)
        else:
