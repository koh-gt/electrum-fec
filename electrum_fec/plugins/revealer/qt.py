...
from electrum_fec.util import make_dir, InvalidPassword, UserCancelled
from electrum_fec.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                      WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_fec.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_fec.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_fec.gui.qt.password_dialog import PasswordDialog
