...
from electrum_fec.crypto import sha256d, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_fec.bitcoin import public_key_to_p2pkh
from electrum_fec.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_fec import ecc
from electrum_fec.ecc import msg_magic
from electrum_fec.wallet import Standard_Wallet
from electrum_fec import constants
from electrum_fec.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_fec.i18n import _
from electrum_fec.keystore import Hardware_KeyStore
from electrum_fec.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_fec.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_fec.network import Network
from electrum_fec.logging import get_logger
from electrum_fec.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-FEC-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
