...
from electrum_fec import bip32, constants
from electrum_fec.i18n import _
from electrum_fec.keystore import Hardware_KeyStore
from electrum_fec.transaction import PartialTransaction
from electrum_fec.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from electrum_fec.util import bh2u, UserFacingException
from electrum_fec.base_wizard import ScriptTypeNotSupported, BaseWizard
from electrum_fec.logging import get_logger
from electrum_fec.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_fec.simple_config import SimpleConfig
from electrum_fec.json_db import StoredDict
from electrum_fec.storage import get_derivation_used_for_hw_device_encryption
from electrum_fec.bitcoin import OnchainOutputType

import electrum_fec.bitcoin as bitcoin
import electrum_fec.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def coin_network_from_electrum_network(self) -> int:
        if constants.net.TESTNET:
            return bitbox02.btc.TFEC
        return bitbox02.btc.FEC
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            if coin_network == bitbox02.btc.FEC:
    ...
    def _get_coin(self):
        return bitbox02.btc.TFEC if constants.net.TESTNET else bitbox02.btc.FEC
