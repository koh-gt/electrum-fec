...
from electrum_fec import ecc, constants
from electrum_fec import bip32
from electrum_fec.crypto import hash_160
from electrum_fec.bitcoin import int_to_hex, var_int, is_segwit_script_type, is_b58_address
...
from electrum_fec.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_fec.wallet import Standard_Wallet
from electrum_fec.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_fec.base_wizard import ScriptTypeNotSupported
from electrum_fec.logging import get_logger
from electrum_fec.plugin import runs_in_hwd_thread, Device
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Ferrite" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Ferrite mode")) from e
                raise e
